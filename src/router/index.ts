...
const routes = [
  ...
  { path: '/equipment-hub', name: 'EquipmentHub', component: () => import('../pages/EquipmentHub.vue') },
  ...
  // Admin routes
  { path: '/admin/dashboard', name: 'AdminDashboard', component: () => import('../pages/admin/Dashboard.tsx') },
  { path: '/admin/users', name: 'UserManagement', component: () => import('../pages/admin/UserManagement.tsx') },
  { path: '/admin/groups', name: 'GroupManagement', component: () => import('../pages/admin/GroupManagement.tsx') },
  { path: '/admin/content', name: 'ContentManagement', component: () => import('../pages/admin/ContentManagement.tsx') },
  { path: '/admin/orders', name: 'OrderManagement', component: () => import('../pages/admin/OrderManagement.tsx') },
  { path: '/admin/analytics', name: 'Analytics', component: () => import('../pages/admin/Analytics.tsx') },
  { path: '/admin/settings', name: 'AdminSettings', component: () => import('../pages/admin/Settings.tsx') },
];
